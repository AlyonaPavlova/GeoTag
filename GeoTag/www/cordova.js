 ...
 */
var cordova = require('GeoTag/www/cordova'),
...
channel.join(function() {
    ...
    // side.
    channel.join(function() {
        require('GeoTag/www/cordova').fireDocumentEvent('deviceready');
...
module.exports = {
    ...
    bootstrap: function() {
        var channel = require('cordova/channel'),
            cordova = require('GeoTag/www/cordova'),
...
window.cordova = require('GeoTag/www/cordova');
